        ...
        <div className='container mt-5' id="Amenities">
            ...
            <div className='row justify-content-center'>
                <div className='col-md-3 col-4 mt-3' style={{border:"1px solid black", borderRadius:"10px", padding:"10px", marginRight:"30px", boxShadow:"2px 4px 4px 1px grey"}}>
                    <div className='row'>
                        <div className='col-md-3'><svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 512 512" viewBox="0 0 512 512" id="clubhouse"><path d="M491,171h10c5.523,0,10-4.477,10-10v-40c0-5.523-4.477-10-10-10h-70c0-31.511,0-68.17,0-100c0-5.523-4.477-10-10-10H91
			...
			z M321,271v180h-55V271H321z M246,271v180h-55V271H246z M421,361V261h50v100H421z M21,151v-20h470v20H21z"></path></svg></div>
                ...
                <div className='col-md-3 col-4 mt-3' style={{border:"1px solid black", borderRadius:"10px", padding:"10px", marginRight:"30px", boxShadow:"2px 4px 4px 1px grey"}}>
                    <div className='row'>
                        <div className='col-md-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 68 68" viewBox="0 0 68 68" id="lift"><path fill="#010101" d="M60.05347,1H7.94653c-2.20557,0-4,1.79443-4,4v61c0,0.55225,0.44775,1,1,1c50.38961,0,7.69552,0,58.10693,0
